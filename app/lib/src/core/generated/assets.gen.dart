...
class $AssetsBrandingGen {
  ...
  AssetGenImage get appIcon =>
      const AssetGenImage('assets/branding/app_icon.png');
  ...
  /// File path: assets/branding/branding.png
  AssetGenImage get branding =>
      const AssetGenImage('assets/branding/branding.png');

  /// File path: assets/branding/splash_logo.png
