...
class _NewsShellPageState extends ConsumerState<NewsShellPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      bottomSheet: const MiniPlayer(), // Persistent Audio Controls
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          if (_selectedIndex == 0) {
            await ref.read<FetchNews>(fetchNewsProvider).call();
          }
        },
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                ListTile(
                  ...
                  subtitle: const Text('Manage blocked topics'),
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute<void>(
                        builder: (context) => const MutedKeywordsPage(),
                      ),
                    );
                  },
                ),
